...
function getSpecialCurveProfile(p1, p2) {
    ...
    if (SPECIAL_CURVES[key1] !== undefined)
        return parseElevationString(SPECIAL_CURVES[key1]);

    if (SPECIAL_CURVES[key2] !== undefined)
        return parseElevationString(SPECIAL_CURVES[key2]);
        ...
        for (var i = 0; i < points.length - 1; i++) {
            ...
            for (var s = 1; s <= segments; s++) {
                ...
                if (specialProfile !== null) {
                    ...
                    // Influence locale autour des 3 points
